...
type userR struct {
	UsersPDFS UsersPDFSlice `boil:"UsersPDFS" json:"UsersPDFS" toml:"UsersPDFS" yaml:"UsersPDFS"`
}
...
func (r *userR) GetUsersPDFS() UsersPDFSlice {
	if r == nil {
		return nil
	}
	return r.UsersPDFS
...
var (
	userAllColumns            = []string{"id", "created_at"}
	userColumnsWithoutDefault = []string{"id", "created_at"}
...
// UsersPDFS retrieves all the users_pdf's UsersPDFS with an executor.
func (o *User) UsersPDFS(mods ...qm.QueryMod) usersPDFQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"users_pdfs\".\"user_id\"=?", o.ID),
	)

	return UsersPDFS(queryMods...)
}

// LoadUsersPDFS allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUsersPDFS(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`users_pdfs`),
		qm.WhereIn(`users_pdfs.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load users_pdfs")
	}

	var resultSlice []*UsersPDF
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice users_pdfs")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on users_pdfs")
	}
	...
	if singular {
		object.R.UsersPDFS = resultSlice
...
// AddUsersPDFS adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UsersPDFS.
// Sets related.R.User appropriately.
func (o *User) AddUsersPDFS(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsersPDF) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.UsersPDFS = append(o.R.UsersPDFS, related...)
	}
